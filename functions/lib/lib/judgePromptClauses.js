...
exports.ANTI_EXPANSION_CLAUSE = exports.STRICT_ANCHOR_CLAUSE = void 0;
exports.strictJudgingClauses = strictJudgingClauses;
/** Fix for PARTIAL SATISFACTION: a level requires everything it describes. */
exports.STRICT_ANCHOR_CLAUSE = `CALIBRACION ESTRICTA DE NIVELES: cada nivel (0, 20, 40, 60, 80, 100) describe TODO lo que la respuesta `
...
exports.ANTI_EXPANSION_CLAUSE = `EVALUA SOLO LO QUE PIDE LA RUBRICA: juzga la respuesta unicamente contra las dimensiones y penalizaciones `
 ...
 */
function strictJudgingClauses() {
    return `\n\nREGLAS DE VERIFICACION (aplican a TODAS las dimensiones):\n`
        + `- ${exports.STRICT_ANCHOR_CLAUSE}\n`
        + `- ${exports.ANTI_EXPANSION_CLAUSE}`;
}
//# sourceMappingURL=judgePromptClauses.js.map
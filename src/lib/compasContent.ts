...
import instrumentoAyD from '../../content/compas/ai_democracy_2026/instrumento_v1.json';
import arquetiposAyD from '../../content/compas/ai_democracy_2026/arquetipos_v1.json';

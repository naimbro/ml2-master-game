...
import aydC03Config from '../../content/sessions/ai_democracy_2026/clase_03_backlash/config.json';
import aydC03Scenarios from '../../content/sessions/ai_democracy_2026/clase_03_backlash/scenarios.json';
...
import aydC07Config from '../../content/sessions/ai_democracy_2026/clase_07_automatizacion/config.json';
import aydC07Scenarios from '../../content/sessions/ai_democracy_2026/clase_07_automatizacion/scenarios.json';
...
import dvC02Config from '../../content/sessions/dataviz_2026/clase_02_primeros_pasos_r/config.json';
...
import dvC04Config from '../../content/sessions/dataviz_2026/clase_04_filtrar_elegir_crear/config.json';
import dvC04Scenarios from '../../content/sessions/dataviz_2026/clase_04_filtrar_elegir_crear/scenarios.json';
import dvC04Rubric from '../../content/sessions/dataviz_2026/clase_04_filtrar_elegir_crear/rubric.json';
import dvC04KnowledgeBase from '../../content/sessions/dataviz_2026/clase_04_filtrar_elegir_crear/knowledge_base.md?raw';
import dvC05Config from '../../content/sessions/dataviz_2026/clase_05_arreglar_y_crear/config.json';
import dvC05Scenarios from '../../content/sessions/dataviz_2026/clase_05_arreglar_y_crear/scenarios.json';
import dvC05Rubric from '../../content/sessions/dataviz_2026/clase_05_arreglar_y_crear/rubric.json';
import dvC05KnowledgeBase from '../../content/sessions/dataviz_2026/clase_05_arreglar_y_crear/knowledge_base.md?raw';
import dvC07Config from '../../content/sessions/dataviz_2026/clase_07_mutate_agrupar_resumir/config.json';
...
import mgtC02Config from '../../content/sessions/mgt300_2026/clase_02_autoexplotacion/config.json';
...
import mgtC04Config from '../../content/sessions/mgt300_2026/clase_04_ia_intimidad_afecto/config.json';
...
export const SESSIONS: SessionOption[] = [
  ...
  {
    id: 'clase_03_backlash',
    courseId: 'ai_democracy_2026',
    title: aydC03Config.title,
    description: aydC03Config.description,
    rounds: aydC03Scenarios.length,
    duration: Math.round(aydC03Config.roundDurationSeconds / 60),
    config: aydC03Config,
  ...
  {
    id: 'clase_07_automatizacion',
    courseId: 'ai_democracy_2026',
    title: aydC07Config.title,
    description: aydC07Config.description,
    rounds: aydC07Scenarios.length,
    duration: Math.round(aydC07Config.roundDurationSeconds / 60),
    config: aydC07Config,
  ...
  {
    id: 'clase_02_primeros_pasos_r',
    courseId: 'dataviz_2026',
    title: dvC02Config.title,
    description: dvC02Config.description,
    rounds: dvC02Scenarios.length,
    duration: Math.round(dvC02Config.roundDurationSeconds / 60),
    config: dvC02Config,
  ...
  {
    id: 'clase_04_filtrar_elegir_crear',
    courseId: 'dataviz_2026',
    title: dvC04Config.title,
    description: dvC04Config.description,
    rounds: dvC04Scenarios.length,
    duration: Math.round(dvC04Config.roundDurationSeconds / 60),
    config: dvC04Config,
    scenarios: dvC04Scenarios,
    rubric: dvC04Rubric,
    knowledgeBase: dvC04KnowledgeBase,
  },
  {
    id: 'clase_05_arreglar_y_crear',
    courseId: 'dataviz_2026',
    title: dvC05Config.title,
    description: dvC05Config.description,
    rounds: dvC05Scenarios.length,
    duration: Math.round(dvC05Config.roundDurationSeconds / 60),
    config: dvC05Config,
    scenarios: dvC05Scenarios,
    rubric: dvC05Rubric,
    knowledgeBase: dvC05KnowledgeBase,
  },
  {
    id: 'clase_07_mutate_agrupar_resumir',
    courseId: 'dataviz_2026',
    title: dvC07Config.title,
    description: dvC07Config.description,
    rounds: dvC07Scenarios.length,
    duration: Math.round(dvC07Config.roundDurationSeconds / 60),
    config: dvC07Config,
  ...
  {
    id: 'clase_02_autoexplotacion',
    courseId: 'mgt300_2026',
    title: mgtC02Config.title,
    description: mgtC02Config.description,
    rounds: mgtC02Scenarios.length,
    duration: Math.round(mgtC02Config.roundDurationSeconds / 60),
    config: mgtC02Config,
  ...
  {
    id: 'clase_04_ia_intimidad_afecto',
    courseId: 'mgt300_2026',
    title: mgtC04Config.title,
    description: mgtC04Config.description,
    rounds: mgtC04Scenarios.length,
    duration: Math.round(mgtC04Config.roundDurationSeconds / 60),
    config: mgtC04Config,
